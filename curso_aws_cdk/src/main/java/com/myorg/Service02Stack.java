...
public class Service02Stack extends Stack {
    public Service02Stack(final Construct scope, final String id, Cluster cluster, SnsTopic productEventsTopic, Table productEventsDb) {
        this(scope, id, null, cluster, productEventsTopic, productEventsDb);
    }

    public Service02Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic, Table productEventsDb) {
        ...
        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("camilaferreiranas/aws_project02"))
                                .containerPort(9090)
                                .logDriver(LogDriver.awsLogs(AwsLogDriverProps
                                        .builder()
                                        .logGroup(LogGroup.Builder.create(this, "Service02LogGroup").
                                                logGroupName("Service02").removalPolicy(RemovalPolicy.DESTROY).build()).
        ...
        productEventsDb.grantReadWriteData(service02.getTaskDefinition().getTaskRole());
