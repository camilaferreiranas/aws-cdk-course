...
public class SnsStack extends Stack {
    ...
    public SnsStack(final Construct scope, final String id, final StackProps props) {
        ...
        productEventsTopic = SnsTopic.Builder.create(Topic.Builder.create(this, "ProductsEventsTopic").topicName("products-events").build()).build();
        productEventsTopic.getTopic().addSubscription(EmailSubscription.Builder.create("camilafn79@gmail.com").json(true).build());
