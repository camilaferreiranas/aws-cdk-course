...
public class Service01Stack extends Stack {
    ...
    public Service01Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic, Bucket invoiceBucket, Queue invoiceQueue) {
        ...
        envVariables.put("AWS_SNS_TOPIC_PRODUT_EVENTS", productEventsTopic.getTopic().getTopicArn());
        ...
        ApplicationLoadBalancedFargateService service01 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("camilaferreiranas/aws_project01"))
                                .containerPort(8080)
                                .logDriver(LogDriver.awsLogs(AwsLogDriverProps
                                        .builder()
                                        .logGroup(LogGroup.Builder.create(this, "Service01").
                                                logGroupName("Service01").removalPolicy(RemovalPolicy.DESTROY).build()).
